...
const benefits = [
    { title: "Deep Hydration", description: "Keeps your skin moisturized and plump all day." },
    { title: "Brightens Skin", description: "Enhances your natural glow and reduces dullness." },
    { title: "Soothes Irritation", description: "Calms redness and reduces sensitivity." },
    { title: "Anti-Aging Properties", description: "Fights wrinkles and fine lines for youthful skin." },
    { title: "Protects Against Pollution", description: "Shields your skin from environmental damage." },
...
export default function ProductBenefits() {
  ...
  return (
    <div className="w-full flex flex-col items-center py-16 relative top-[55px]">
          ...
          <AnimatePresence mode="wait">
            {[-1, 0, 1].map((offset) => {
              ...
              return (
                ...
                >
                  <h3 className="text-2xl font-semibold text-accent">{benefits[currentIndex].title}</h3>
                  <p className="text-gray-600 mt-2">{benefits[currentIndex].description}</p>
                </motion.div>
              );
            })}
          </AnimatePresence>
